...
class PaymentService:
    def __init__(self):
        self.BASE_URL = 'http://localhost:3000/'#"http://blackwilbur.com/"  # Replace with your domain
        self.MERCHANT_ID = 'PGTESTPAYUAT86' #'M224GLLI0GBI1'
        self.SALT_KEY = '96434309-7796-489d-8924-ab56988a6076'  # Corrected
        self.INDEX = "1"
    ...
    def pay(self, amount, user_id, mobile_number):
        ...
        MAINPAYLOAD = {
            ...
            "amount": amount,
            "redirectUrl": "http://127.0.0.1:5000/phonepe-callback/",#'https://blackwilbur.com/orderConfirmation', #
            "redirectMode": "POST",
            "callbackUrl": "http://127.0.0.1:5000/phonepe-callback/",
